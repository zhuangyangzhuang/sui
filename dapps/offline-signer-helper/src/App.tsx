...
const CodePanel = ({ title, json }: { title: string; json: object | null }) => (
  <div>
...
// AAACAAhkAAAAAAAAAAAIZAAAAAAAAAACAgABAQAAAgABAQEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAIBI5gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA0BQAAAAAAABQAAQIDBAUGBwgJAAECAwQFBgcICQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACBQAAAAAAAABkAAAAAAAAAAA=
