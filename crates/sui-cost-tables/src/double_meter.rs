...
impl GasStatus {
    ...
    pub fn new_v2(
        ...
        Self {
            ...
            new: T::GasStatus::new_v2(initial_cost_schedule_v2(), budget, gas_price, 5),
    ...
    pub fn charge_bytes(&mut self, size: usize, cost_per_byte: u64) -> PartialVMResult<()> {
        self.new.charge_bytes(size, cost_per_byte);
